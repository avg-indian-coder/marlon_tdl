...
class TrafficGen:
    ...
    def generate_routefile(self, seed, weibull=True):
        ...
        if platform.system() == 'Windows':
            ...
            cmd_code = f'python3 /$SUMO_HOME/tools/randomTrips.py --seed {seed} --validate -r {self._route} --end {self._no_vehicles} -n {self._net} > /dev/null'
...
if __name__ == '__main__':
    ...
    generator = TrafficGen('nets/bo/network.net.xml', 'nets/3x3/evaluation.rou.xml', 5400, 2000, 0.1)
