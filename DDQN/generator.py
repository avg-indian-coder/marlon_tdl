...
if __name__ == '__main__':
    ...
    generator = TrafficGen('nets/3x3/network.net.xml', 'nets/3x3/evaluation_route.rou.xml', 3600, 1000, 0.1)
    car_gen_steps = generator.generate_routefile(420, weibull=True)
